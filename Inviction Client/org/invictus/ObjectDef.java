...
public final class ObjectDef {
	...
	public static ObjectDef forID(int i) {
		...
		case 3515:
			objectDef.name = "Completionist cape stand";
			objectDef.description = "I can obtain a Completionist cape here.".getBytes();
		...
		case 26380:
		case 26381:
			objectDef.name = "Frozen door";
			objectDef.description = "A door to Nex's Ancient Prison...".getBytes();
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Enter";
			break;

		case 11357:
			objectDef.name = "Custom portal";
			objectDef.description = "I can teleport to this at any time.".getBytes();
			objectDef.actions = new String[5];
			objectDef.actions[0] = "Remove-portal";
			break;
