...
public class SpriteLoader {
	...
	public static void loadSprites(StreamLoader streamLoader) {
		try {
			Stream index = new Stream(Utility.readFile(Signlink.findcachedir() + "sprites.idx"));
			Stream data = new Stream(Utility.readFile(Signlink.findcachedir() + "sprites.dat"));
	...
	public static void createSprite(SpriteLoader sprite) {
		 ...
		 * (!directory.exists()) { directory.mkdir(); } Utility.writeFile(new
