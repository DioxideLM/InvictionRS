						...
						if (k17 >= 1 && k17 < anInt147 - 1 && (!lowMem || (aByteArrayArrayArray149[0][l6][k17] & 2) != 0 || (aByteArrayArrayArray149[l][l6][k17] & 0x10) == 0 && method182(k17, l, l6) == anInt131)) {
							...
							if (l18 > 0 || i19 > 0) {
								...
								if (l > 0) {
									...
									if (i19 > 0 && !OverLayFlo474.overLayFlo474s[i19 - 1].aBoolean393) {
										flag = false;
									}
								...
								if (i19 == 0) {
									...
									OverLayFlo474 overlay_flo = OverLayFlo474.overLayFlo474s[i19 - 1];
									...
									worldController.method279(l, l6, k17, k22, byte4, textureId, j19, k19, l19, i20, method187(j21, j20), method187(j21, k20), method187(j21, l20), method187(j21, i21), method185(j23, j20), method185(j23, k20), method185(j23, l20), method185(j23, i21), i22, k23);
								}
							}
						}
					}
