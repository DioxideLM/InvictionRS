package org.invictus.world.map;
...
public class VirtualWorld {
	...
	public static final void init() {
		...
		org.invictus.world.map.I.Iz(true);
	...
	public static final boolean I(int height, int currentX, int currentY,
		...
		if (currentX != futureX && futureY != currentY) {
			return org.invictus.world.map.I.Iz(height, currentX, currentY, currentX,
					futureY, a)
					&& org.invictus.world.map.I.Iz(height, currentX, currentY,
							futureX, currentY, a)
					&& org.invictus.world.map.I.Iz(height, currentX, currentY,
							futureX, futureY, a);
		}
		return org.invictus.world.map.I.Iz(height, currentX, currentY, futureX,
				futureY, a);
	}
