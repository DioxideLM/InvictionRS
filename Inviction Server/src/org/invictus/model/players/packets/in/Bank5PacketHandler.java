 ...
 * Bank 5 Items
 **/
public class Bank5PacketHandler implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		case 5064:
			...
			c.getBank().bankItem(removeId, removeSlot, 5);
			break;

		case 5382:
			c.getBank().fromBank(removeId, removeSlot, 5);
			break;
		...
		case 3322:
			if (c.duelStatus <= 0) {
				...
				c.getDuelArena().stakeItem(removeId, removeSlot, 5);
			}
			break;
		...
		case 6669:
			c.getDuelArena().fromDuel(removeId, removeSlot, 5);
			break;
