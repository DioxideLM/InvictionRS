...
public class Connection {
	...
	public static void unMuteUser(String name) {
		...
		deleteFromFile("./data/punishments/UsersMuted.txt", name);
	}

	public static void unIPMuteUser(String name) {
		mutedIps.remove(name);
		deleteFromFile("./data/punishments/IpsMuted.txt", name);
	}
	
	public static void unIPBanUser(String name) {
		bannedIps.remove(name);
		deleteFromFile("./data/punishments/IpsBanned.txt", name);
	}
	...
	public static void removeNameFromBanList(String name) {
		...
		deleteFromFile("./data/punishments/UsersBanned.txt", name);
	}
	...
	public static void banUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishments/UsersBanned.txt"));
			String data = null;
			try {
	...
	public static void muteUsers() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishments/UsersMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedNames.add(data);
	...
	public static void banIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishments/IpsBanned.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					addIpToBanList(data);
	...
	public static void muteIps() {
		try {
			BufferedReader in = new BufferedReader(new FileReader("./data/punishments/IpsMuted.txt"));
			String data = null;
			try {
				while ((data = in.readLine()) != null) {
					mutedIps.add(data);
	...
	public static void addNameToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishments/UsersBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addUserToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishments/UsersMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishments/IpsBanned.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
	...
	public static void addIpToMuteFile(String Name) {
		try {
			BufferedWriter out = new BufferedWriter(new FileWriter("./data/punishments/IpsMuted.txt", true));
			try {
				out.newLine();
				out.write(Name);
			} finally {
